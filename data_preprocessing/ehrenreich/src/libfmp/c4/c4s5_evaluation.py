...
def plot_seq_label(ax, X, Fs=1, color_label=[], direction='horizontal',
    ...
    Args:
        ...
        direction: Parameter used for :func:`src.libfmp.b.b_plot.plot_segments` (Default value = 'horizontal')
        fontsize: Parameter used for :func:`src.libfmp.b.b_plot.plot_segments` (Default value = 10)
        time_axis: Parameter used for :func:`src.libfmp.b.b_plot.plot_segments` (Default value = False)
        print_labels: Parameter used for :func:`src.libfmp.b.b_plot.plot_segments` (Default value = True)
    ...
    src.libfmp.b.plot_segments(ann_X, ax=ax, time_axis=time_axis, fontsize=fontsize,
...
def plot_matrix_pairwise(I_eval, figsize=(3, 2.5)):
    """Plot matrix I_eval encoding TP, FN, FP (see :func:`src.libfmp.c4.c4s5_evaluation.evaluate_pairwise`)
...
def plot_boundary_measures(B_ref, B_est, tau, figsize=(8, 2.5)):
    """Plot B_ref and B_est (see :func:`src.libfmp.c4.c4s5_evaluation.evaluate_boundary`)

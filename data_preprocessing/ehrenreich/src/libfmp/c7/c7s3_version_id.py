...
def compute_sm_from_wav(x1, x2, Fs, N=4410, H=2205, ell=21, d=5, L_smooth=12,
    ...
    Fs_C = Fs / H
    X, Fs_feature = src.libfmp.c7.compute_cens_from_chromagram(C1, Fs_C, ell=ell, d=d)
    Y, Fs_feature = src.libfmp.c7.compute_cens_from_chromagram(C2, Fs_C, ell=ell, d=d)
